import {Input, ChooseCategoryDropdown, DateTimeBar} from "../components/addBlog.jsx"
...
<Container2>
<Container3>
<Input blogs={props.blogs} users={props.users} setBlogs={props.setBlogs} input={props.input} setInput={props.setInput} content={props.content} setContent={props.setContent} file={props.file} setFile={props.setFile} category={props.category} setCategory={props.setCategory}
        ...
        <ChooseCategoryDropdown category={props.category} setCategory={props.setCategory}/>
        
        <DateTimeBar dueyear={props.dueyear} setDueyear={props.setDueyear}  duemonth={props.duemonth} setDuemonth={props.setDuemonth} dueday={props.dueday} setDueday={props.setDueday}
        />
        </Container3>
</Container2>
