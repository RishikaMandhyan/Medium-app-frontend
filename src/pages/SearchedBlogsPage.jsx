...
export const SearchedBlogsPage=(props)=>{
    return (<>        
            <Master_container>
            ...
            <ViewTaskDropdown blogs={props.blogs} setBlogs={props.setBlogs}/>
                ...
                <SearchedBlogs blogs={props.blogs} setBlogs={props.setBlogs}  blog_user_likes={props.blog_user_likes} setBlogUserLikes={props.setBlogUserLikes} 
