...
export const CategoryBlogsPage=(props)=>{
    return (<>
            ...
            <ViewTaskDropdown blogs={props.blogs} setBlogs={props.setBlogs}/>
                ...
                <CategoryBlogs blogs={props.blogs} setBlogs={props.setBlogs}  blog_user_likes={props.blog_user_likes} setBlogUserLikes={props.setBlogUserLikes} 
