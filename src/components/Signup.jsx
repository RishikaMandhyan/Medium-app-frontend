...
export const SignUp = (props) => {
  return (
    <Master_container>
    <div class="c10">
      <Heading>Welcome to Blogger<br/><br/>Sign Up</Heading>
      <Formik
        initialValues={{
          name: "",
          password: "",
        ...
        onSubmit={(values) => { 
            ...
            values={...values, id: props.user_uid, number_followers:0, number_following:0, plan_id: plan_id, views:0};
      ...
      >
        {({
          ...
          <form class="c12" noValidate onSubmit={handleSubmit}>
            ...
            <button class="submit submit2" type="submit"><Link to={`/login`} style={{ textDecoration: 'none', color: 'black' }}>Login if you are already a user</Link></button>
          </form>
        )}
      </Formik>
    </div>
